...
<div id="container">
 ...
 <header id="header">
  ...
  <div id="site_desc" class="rich_font_<?php echo esc_attr($options['header_desc_font_type']); ?>"><span<?php if ($options['header_desc_mobile']) { echo ' class="pc"'; }; ?>><?php echo esc_html(get_bloginfo('description')); ?></span><?php if ($options['header_desc_mobile']) { echo '<span class="mobile rich_font_' . esc_attr($options['header_desc_font_type_mobile']) . '">' . nl2br(esc_html($options['header_desc_mobile'])) . "</span>"; }; ?></div>
